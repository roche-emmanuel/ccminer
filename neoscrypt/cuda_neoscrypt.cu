...
static __device__ __inline__ void chacha_step4(uint32_t* X)
{
	asm volatile ("{\n\t"
		...
		".reg .u32 s0,s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15; \n\t"
		"ld.v4.u32 {s0,s1,s2,s3}, [%16]; \n\t"
		"ld.v4.u32 {s4,s5,s6,s7}, [%16+16]; \n\t"
		"ld.v4.u32 {s8,s9,s10,s11}, [%16+32]; \n\t"
		"ld.v4.u32 {s12,s13,s14,s15}, [%16+48]; \n\t"
  ...
  //   "shf.l.wrap.b32 %4, %4, %4, 7; \n\t"
    ...
    : "+r"(X[0]), "+r"(X[1]), "+r"(X[2]), "+r"(X[3]), 
      ...
      "+r"(X[12]),"+r"(X[13]),"+r"(X[14]),"+r"(X[15]) : "l"(X)); //, "+r"(X[4]), "+r"(X[5]), "+r"(X[6]), "+r"(X[7])
}
